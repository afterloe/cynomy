...
const [createFile, {strToKeyValue, getFormateTime}, {get}, {addFiles, commitChange, getBranchInfo, gitStatus, getGitUserInfo, pushChange}] =
[require(resolve(__dirname, "createFile")), require(resolve(__dirname, "..", "tools", "currency")), require(resolve(__dirname, "..", "config")), require(resolve(__dirname, "..", "tools", "gitExtends"))];
