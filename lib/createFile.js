...
const [{get}, {fileParse}] = [require(resolve(__dirname, "..", "config")), require(resolve(__dirname, "content"))];
...
module.exports = (file, ...options) => {
  ...
  * ${get("author")} - ${buildRelativePath(fullName, root)}
  *
