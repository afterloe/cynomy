...
const [{join, resolve}, {writeFile, readdirSync, mkdirSync, createReadStream, createWriteStream}] = [require("path"), require("fs")];
const createFile = require(resolve(__dirname, "createFile"));
...
const structureDir = root => {
    mkdirSync(resolve(root, "config"));
    console.log("create dir config ... SUCCESS! ");
    mkdirSync(resolve(root, "test"));
    console.log("create dir test ... SUCCESS! ");
    mkdirSync(resolve(root, "doc"));
    console.log("create dir doc ... SUCCESS! ");
