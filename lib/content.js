...
// 申明文件内容职责链
const [jsNode, htmlNode, cssNode, bashNode, pythonNode, markdownNode ,binaryNode] = [new Chain(createJSFile),
...
// 设置文件内容职责链
jsNode.setNext(htmlNode).setNext(cssNode).setNext(bashNode).setNext(pythonNode).setNext(markdownNode).setNext(binaryNode);
